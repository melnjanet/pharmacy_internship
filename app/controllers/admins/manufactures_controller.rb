class Admins::ManufacturesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @manufacture.save
        format.html { redirect_to admins_manufacture_url(@manufacture), notice: "Manufacture was successfully created." }
  ...
  def update
    respond_to do |format|
      if @manufacture.update(manufacture_params)
        format.html { redirect_to admins_manufacture_url(@manufacture), notice: "Manufacture was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admins_manufactures_url, notice: "Manufacture was successfully destroyed." }

class Admins::NomenclaturesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @nomenclature.save
        format.html { redirect_to admins_nomenclature_url(@nomenclature), notice: "Nomenclature was successfully created." }
  ...
  def update
    respond_to do |format|
      if @nomenclature.update(nomenclature_params)
        format.html { redirect_to admins_nomenclature_url(@nomenclature), notice: "Nomenclature was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admins_nomenclatures_url, notice: "Nomenclature was successfully destroyed." }

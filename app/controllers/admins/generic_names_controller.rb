class Admins::GenericNamesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @generic_name.save
        format.html { redirect_to admins_generic_name_url(@generic_name), notice: "Generic Name was successfully created." }
  ...
  def update
    respond_to do |format|
      if @generic_name.update(generic_name_params)
        format.html { redirect_to admins_generic_name_url(@generic_name), notice: "Generic Name was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admins_generic_names_url, notice: "Generic Name was successfully destroyed." }

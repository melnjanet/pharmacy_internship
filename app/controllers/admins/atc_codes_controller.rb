class Admins::AtcCodesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @atc_code.save
        format.html { redirect_to admins_atc_code_url(@atc_code), notice: "AtcCode was successfully created." }
  ...
  def update
    respond_to do |format|
      if @atc_code.update(atc_code_params)
        format.html { redirect_to admins_atc_code_url(@atc_code), notice: "AtcCode was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admins_atc_codes_url, notice: "AtcCode was successfully destroyed." }
